...
["ant", "bear", "cat"].any? { |word| word.length >= 3 } # => true, el resultado es true porque se pregunta si es que el tamaño de las palabras antes expuestas es mayor o igual a 3.
